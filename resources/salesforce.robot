...
*** Variables ***
${BROWSER}               chrome
${username}              ebartlik+crtdemo@copado.com
${login_url}             https://copadocrt.my.salesforce.com/            # Salesforce instance. NOTE: Should be overwritten in CRT variables
...
LogOut
    [Documentation]     Logs out of Salesforce
    GoTo                 ${home_url}
    VerifyText           Home
    ClickItem            uiImage
    ClickText            Log Out                
